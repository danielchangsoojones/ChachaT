...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-ChachaT/ExpandingMenu.framework"
  install_framework "Pods-ChachaT/FBSDKCoreKit.framework"
  install_framework "Pods-ChachaT/FBSDKLoginKit.framework"
  install_framework "Pods-ChachaT/JSQMessagesViewController.framework"
  install_framework "Pods-ChachaT/JSQSystemSoundPlayer.framework"
  ...
  install_framework "Pods-ChachaT/ParseFacebookUtilsV4.framework"
  install_framework "Pods-ChachaT/ParseUI.framework"
  install_framework "Pods-ChachaT/Ripple.framework"
  install_framework "Pods-ChachaT/SCLAlertView.framework"
  install_framework "Pods-ChachaT/STPopup.framework"
