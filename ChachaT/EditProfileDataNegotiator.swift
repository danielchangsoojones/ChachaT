//
//  EditProfileDataNegotiator.swift
//  ChachaT
//
...
protocol EditProfileDataNegotiatorDelegate {
...
class EditProfileDataNegotiator {
    let currentUser = User.current()!
    var delegate: EditProfileDataNegotiatorDelegate?
    
    init(delegate: EditProfileDataNegotiatorDelegate) {
...
extension EditProfileDataNegotiator {
    func loadEverything() {
        loadProfileImages()
        loadBulletPoints()
        loadTexts()
