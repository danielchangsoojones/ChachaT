...
//    var dropDownMenuType: DropDownAttributes = .TagChoices //just giving it a default
//    
...
//            dropDownMenuType = .TagChoices //even though defualted to this, I need to make sure it changes when it was a different type, and then goes back to .SpecialtyTagMenu
