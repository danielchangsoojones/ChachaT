...
open class TagListView: UIView {
    ...
    fileprivate func rearrangeViews() {
        ...
        for (index, tagView) in tagViews.enumerated() {
            ...
            //Added by Daniel Jones. I have no idea why, but when I try clipsToBounds = false in the PendingTagView, it breaks. But, when I set it here, the little pending shows up, no freaking idea why
